...
import Assignment.src.view.CompanyRepresentativeView;
...
public class CompanyRepresentativeController {
    ...
    public void createInternship() {
        try {
            ...
            if (internship != null) {
                // Save to CSV
                Assignment.src.utils.InternshipCsvHandler.saveToCsv(internship);
    ...
    public void viewApplications() {
        ...
        if (!internship.isOwnedBy(companyRep)) {
            System.out.println("You don't have permission to view applications for this internship!");
            return;
        }
    ...
    public void toggleVisibility() {
        try {
            ...
            List<Internship> myInternships = Internship.getAllInternships().stream()
                    .filter(i -> i.getCreator().equals(companyRep))
                    .filter(i -> i.getStatus() == Assignment.src.constant.InternshipStatus.APPROVED)
                    .collect(Collectors.toList());
            ...
            if (internship.getStatus() != Assignment.src.constant.InternshipStatus.APPROVED) {
    ...
    public void confirmPlacement() {
        ...
        Assignment.src.model.Application app = internship.getApplications().stream()
        ...
        app.setStatus(Assignment.src.constant.ApplicationStatus.SUCCESSFUL);
