...
public class ApplicationFormatter implements Formatter {
    ...
    public String format(Object object) {
        ...
        if (showInternshipDetails) {
            ...
            details.append(String.format("    Visible: %s%n", internship.getVisibleFlag() ? "Yes" : "No"));
        }
     ...
     */
    public static int displayPaginatedTable(List<?> applications, String header, String emptyMsg,
